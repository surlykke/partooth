 ...
 */
class Adapter1: public QDBusAbstractInterface
{
    Q_OBJECT
public:
...
public:
    Adapter1(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = 0);
...
public Q_SLOTS: // METHODS
    ...
    inline QDBusPendingReply<> SetDiscoveryFilter(PropertyMap properties)
    {
        QList<QVariant> argumentList;
