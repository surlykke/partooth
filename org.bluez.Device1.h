 ...
 * Command line was: qdbusxml2cpp -p org.bluez.Device1 -c Device1 -i dbus_types.h -N xml/org.bluez.Device1.xml
 *
 ...
 */
class Device1: public QDBusAbstractInterface
{
    Q_OBJECT
public:
...
public:
    Device1(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = 0);
